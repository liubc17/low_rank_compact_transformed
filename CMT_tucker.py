...
from cmt_module_tucker import CMTStem, Patch_Aggregate, CMTBlock

__all__ = ['CMT', 'CMT_Ti', 'CMT_XS', 'CMT_S', 'CMT_B']
...
class CMT(nn.Module):
    def __init__(self,
        ...
        # Stem layer
        self.stem = CMTStem(in_channels, stem_channel, ch_com_rate=ch_com_rate, kernel_size=kernel_size,
...
def CMT_Ti(ch_com_rate=0.5, kernel_size=3, compress_size=3, img_size=224, num_class=1000):
    model = CMT(
        in_channels=3,
        stem_channel=16,
        ch_com_rate=ch_com_rate,
...
def CMT_XS(ch_com_rate=0.5, kernel_size=3, compress_size=3, img_size=224, num_class=1000):
    model = CMT(
        in_channels=3,
        stem_channel=16,
        ch_com_rate=ch_com_rate,
...
def CMT_S(ch_com_rate=0.5, kernel_size=3, compress_size=3, img_size=224, num_class=1000):
    model = CMT(
        in_channels=3,
        stem_channel=32,
        ch_com_rate=ch_com_rate,
...
def CMT_B(ch_com_rate=0.5, kernel_size=3, compress_size=3, img_size=224, num_class=1000):
    model = CMT(
        in_channels=3,
        stem_channel=38,
        ch_com_rate=ch_com_rate,
