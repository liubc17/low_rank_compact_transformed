...
def main():
    ...
    if args.arch in model_names_tck:
        model = ResNet_tucker.__dict__[args.arch](ch_com_rate=args.com_rate, kernel_size=args.ker_size,
                                                  compress_size=args.com_ker_size, num_classes=100)
    ...
    if args.arch in CMT:
        model = CMT_tucker.__dict__[args.arch](ch_com_rate=args.com_rate, kernel_size=args.ker_size,
                                               compress_size=args.com_ker_size, num_class=100)
        args.batch_size = 64
        args.epochs = 50
        args.lr = 6e-5
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch > 0 and epoch % args.save_every == 0:
            ...
            }, is_best, filename=os.path.join(args.save_dir, 'checkpoint_'+str(args.com_rate)+'_'+str(args.com_ker_size)
                                              + '_' + str(args.ker_size)+'_100.th'))
